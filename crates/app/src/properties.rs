...
impl Viewer {
    ...
    pub(crate) fn render_properties(&mut self, cx: &mut Context<Self>) -> AnyElement {
        ...
        //
        // Один выделенный блок — тоже выделение: так ложится вставленная
        // копия, и панель обязана показать её свойства, а не приглашение
        // выбрать абзац. Иначе выходило враньё: на странице блок обведён, а
        // панель уверяет, что ничего не выбрано.
