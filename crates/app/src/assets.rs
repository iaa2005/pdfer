...
const ASSETS: &[(&str, &[u8])] = icons![
    ...
    "icons/arrow-data-transfer-vertical.svg",
    ...
    "icons/text-bold.svg",
    "icons/text-clear.svg",
    "icons/text-color.svg",
    "icons/text-creation.svg",
    "icons/text-firstline-left.svg",
    "icons/text-font.svg",
    "icons/text-indent-more.svg",
    "icons/text-indent.svg",
    "icons/text-italic.svg",
    "icons/text-kerning.svg",
    "icons/text-selection.svg",
    "icons/text-smallcaps.svg",
    "icons/text-square.svg",
    "icons/text-subscript.svg",
    "icons/text-superscript.svg",
    "icons/text-tracking.svg",
    "icons/text-underline.svg",
    "icons/text-vertical-alignment.svg",
    "icons/text-wrap.svg",
    "icons/undo-03.svg",
